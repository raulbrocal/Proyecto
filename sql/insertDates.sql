...
-- Reservas posibles
INSERT INTO reservationSchedule (table_number, start_time)
VALUES
    (1, '12:30:00'),
    (1, '12:45:00'),
    (1, '13:00:00'),
...
('Mirinda', 355, 'Refresco', 2.50, FALSE),
('7UP', 355, 'Refresco', 2.50, FALSE),
('Mountain Dew', 355, 'Refresco', 2.50, FALSE),
...
('Riesling', 750, 'Vino blanco', 25.00, TRUE),
('Prosecco', 750, 'Vino espumoso', 30.00, TRUE),
('Champagne', 750, 'Vino espumoso', 50.00, TRUE),
('Cava', 750, 'Vino espumoso', 25.00, TRUE),
('Moscato', 750, 'Vino dulce', 18.00, TRUE),
('Port', 750, 'Vino fortificado', 35.00, TRUE),
('Sherry', 750, 'Vino fortificado', 30.00, TRUE),
('Marsala', 750, 'Vino fortificado', 25.00, TRUE),
('Vermouth', 750, 'Vino aromatizado', 20.00, TRUE),
('Rosé', 750, 'Vino rosado', 22.00, TRUE),
('Zinfandel', 750, 'Vino tinto', 28.00, TRUE),
('Gewürztraminer', 750, 'Vino blanco', 25.00, TRUE),
...
('Whiskey Sour', 250, 'Cóctel', 8.00, TRUE),
('Gin Tonic', 250, 'Cóctel', 7.50, TRUE),
('Mint Julep', 250, 'Cóctel', 9.50, TRUE),
('Tequila Sunrise', 250, 'Cóctel', 8.50, TRUE),
('Long Island Iced Tea', 250, 'Cóctel', 12.50, TRUE),
('Rum and Coke', 250, 'Cóctel', 6.50, TRUE),
('White Russian', 250, 'Cóctel', 10.50, TRUE),
